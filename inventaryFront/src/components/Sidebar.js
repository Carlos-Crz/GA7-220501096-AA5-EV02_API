        ...
        <aside class="sidebar" className={`sidebar ${isSidebarHidden ? 'active' : ''} ${isSidebarCollapsed ? 'collapsed' : ''}`}>
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="#" class="sidebar__item" className={`sidebar__item ${location.pathname === '/Gestioncategorias' ? 'sidebar__item--active' : ''}`}>
                            <span class="material-symbols-outlined sidebar__item-icon">
                                category
                            </span>
                    ...
                    <li>
                        <a href="#" class="sidebar__item" className={`sidebar__item ${location.pathname === '/Gestionusuarios' ? 'sidebar__item--active' : ''}`}>
                            <span class="material-symbols-outlined sidebar__item-icon">
                                account_circle
                            </span>
